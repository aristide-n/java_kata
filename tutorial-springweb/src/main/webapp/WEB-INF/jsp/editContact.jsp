...
<table align="center" bgcolor="lightblue" border="1" bordercolor="#006699" height="500"
   ...
   <tr align="center" valign="top">
      <td align="center">
         <form:form action="updateContact.do" commandname="editContact" method="post"></form:form>
         <table border="0" bordercolor="#006699" cellpadding="2" cellspacing="2"
            ...
            <tr>
               ...
               <td align="left">
                  <form:errors cssstyle="color:red" path="id"></form:errors>
               </td>
            </tr>
            <tr>
            ...
            <tr>
               ...
               <td align="left">
                  <form:errors cssstyle="color:red" path="mobile"></form:errors>
               </td>
            </tr>
            <tr valign="bottom">
               <td align="center" colspan="3">
                  <input onclick="javascript:deleteContact('deleteContact.do?id=${editContact.id}');"
