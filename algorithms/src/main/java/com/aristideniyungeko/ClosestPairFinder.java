...
public class ClosestPairFinder {
   ...
   private HashMap<String, Object> findClosestPairInArray(Point2D[] unsortedArray,
      ...
      // Recursion
         ...
         distributePresortedArray(arraySortedByX, leftUnsortedArray, leftArraySortedByX, rightArraySortedByX);
         ...
         distributePresortedArray(arraySortedByY, leftUnsortedArray, leftArraySortedByY, rightArraySortedByY);
